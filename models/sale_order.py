...
class SaleOrder(models.Model):
    ...
    payment_direct_allaconsegna = fields.Monetary(string='Alla consegna', digits='Product Price', default=0.0,currency_field='currency_id', copy=False)
    payment_direct_saldo = fields.Monetary(string='Rimanente a saldo', digits='Product Price', compute='_amount_diretto', default=0.0,currency_field='currency_id', copy=False)
    payment_direct_num_titoli = fields.Integer(string='Da pagare in Numero Titoli', default=0, copy=False)
    payment_direct_importo_titoli = fields.Monetary(string='Importo titoli', compute='_amount_diretto', digits='Product Price', default=0.0,currency_field='currency_id', copy=False)
    ...
    leasing_direct=fields.Boolean(string='Leasing',default=False, copy=False)
    leasing_direct_importo = fields.Monetary(string="Importo", digits='Product Price', default=0.0,currency_field='currency_id', copy=False)
    leasing_direct_macrocanone = fields.Monetary(string='Macrocanone', digits='Product Price', default=0.0,currency_field='currency_id', copy=False)
    leasing_direct_totale = fields.Monetary(string='Totale', store=True, readonly=False, compute='_amount_leasing', tracking=5,currency_field='currency_id', copy=False)
    leasing_direct_numero_rate = fields.Integer(string='Numero Rate', default=0, copy=False)
    leasing_direct_importo_rate = fields.Monetary(string='Importo rate', digits='Product Price', default=0.0,currency_field='currency_id', copy=False)
    leasing_direct_numero_mesi = fields.Integer(string='Numero mesi', default=0, copy=False)
    ...
    finaziamento_direct=fields.Boolean(string='Finaziamento',default=False, copy=False)
    finaziamento_direct_costodelbene = fields.Monetary(string="Costo del bene", digits='Product Price', default=0.0,currency_field='currency_id', copy=False)
    finaziamento_direct_finanziamento = fields.Monetary(string='Finanziamento', digits='Product Price', default=0.0,currency_field='currency_id',  copy=False)
    finaziamento_direct_numero_rate = fields.Integer(string='Numero Rate', default=0, copy=False)
    finaziamento_direct_importo_rate = fields.Monetary(string='Importo rate', digits='Product Price', default=0.0,currency_field='currency_id', copy=False)
...
"")
    ...
    def _recompute_attachment_url(self,numero_contratto=None):
        for record in self:
            ...
            attachment = self.env['ir.attachment'].sudo().search([('res_model', '=', 'res.partner'), ('res_id', '=', record.company_id.partner_id.id)], limit=1)
            try:
